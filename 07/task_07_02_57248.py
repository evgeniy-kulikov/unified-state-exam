...
# https://stepik.org/lesson/421031/step/12?auth=login&unit=410641
"""
1 * Hz * i * sec / 8 = 38
2 * (Hz / 4) * (5 * i) * sec / 8 = ?
...
? = (38 * (2 * (Hz / 4) * (5 * i))) / (1 * Hz * i)
? = 38 * 2 * 0.25 * 5
? = 95 Mb
"""
print(38 * 2 * 0.25 * 5)  # 95 Mb

# https://stepik.org/lesson/421031/step/13?auth=login&unit=410641
"""
2 * Hz * i * sec / 8 = 54
1 * (Hz / 4.5) * (3 * i) * sec / 8 = ?

54 / (2 * Hz * i)  == ? / (1 * (Hz / 4.5) * (3 * i))
? = 54 * (1 * (Hz / 4.5) * (3 * i))  / (2 * Hz * i)
? = (54 * (1 / 4.5) * 3) / 2
"""
print(54 * (1 / 4.5) * 3 / 2)  # 18 Mb


# https://stepik.org/lesson/421031/step/14?auth=login&unit=410641
print(int(4 * 32_000 * 32 * 120 / 8 / 2**20))  # 58  --> 60
