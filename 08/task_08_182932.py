...
""" 9.2 Задания на алфавит с нумерацией """
# https://stepik.org/lesson/1084604/step/1?unit=1094966
print(int('1000', 5) + 1)  # 126


# https://stepik.org/lesson/1084604/step/2?unit=1094966
print(int('7724', 8) + 1)


# https://stepik.org/lesson/1084604/step/4?unit=1094966
alfa = 'АИМРЯ'
n = 210
s = ''
while n:
